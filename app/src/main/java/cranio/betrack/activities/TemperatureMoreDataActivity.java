...
public class TemperatureMoreDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LineChartView chart = (LineChartView) findViewById(R.id.chart1);
        assert chart != null;
        ...
        for (BarrelStatusPojo status : barrelInformationPojo.getBarrelStatus()
            ...
            String partsDay[] = parts[0].split("-");
            String partsHour[]=parts[1].split(":");
            sentAtValues.add(partsDay[2]+"-"+partsDay[1]+" "+partsHour[0]+":"+partsHour[1]+"  ");
        }
        ...
        Axis axisX= Axis.generateAxisFromCollection(axisValues, sentAtValues);
        axisX.setHasTiltedLabels(true);
        axisX.setHasLines(true);
        Axis axisY= Axis.generateAxisFromCollection(temperatureValues);
